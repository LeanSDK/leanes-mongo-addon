...
var MongoAdapterMixin = (Module => {
  ...
  Module.defineMixin(__filename$7, BaseClass => {
    ...
    var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _init, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _temp;
    ...
    let Mixin = (_dec = globalContext$2.annotate(globalContext$2.class("Mixin", Mixin => {
    ...
    })), _dec2 = globalContext$2.decorate(globalContext$2.nullable(globalContext$2.ref("Promise", globalContext$2.ref("object")))), _dec3 = globalContext$2.decorate(globalContext$2.string()), _dec4 = globalContext$2.decorate(globalContext$2.string()), _dec5 = globalContext$2.decorate(globalContext$2.string()), _dec6 = globalContext$2.decorate(globalContext$2.string()), _dec7 = globalContext$2.decorate(globalContext$2.string()), _dec8 = globalContext$2.decorate(globalContext$2.string()), _dec9 = globalContext$2.decorate(globalContext$2.string()), _dec10 = globalContext$2.decorate(globalContext$2.nullable(globalContext$2.string())), _dec11 = globalContext$2.decorate(globalContext$2.nullable(globalContext$2.string())), _dec(_class = initializeMixin(_class = (_class2 = (_temp = (_t$TypeParametersSymb = globalContext$2.TypeParametersSymbol, _class3 = class Mixin extends BaseClass {
      ...
      constructor(...args) {
        ...
        initializerDefineProperty(this, "dbProto", _descriptor5, this);

        initializerDefineProperty(this, "host", _descriptor6, this);

        initializerDefineProperty(this, "port", _descriptor7, this);

        initializerDefineProperty(this, "dbName", _descriptor8, this);

        initializerDefineProperty(this, "username", _descriptor9, this);

        initializerDefineProperty(this, "password", _descriptor10, this);
        ...
        if (this._collection == null) {
          this._collection = (async () => {
            ...
            return await new Promise((resolve, reject) => {
              connection.db(this._dbName).collection(name, {
                strict: true
              }, (err, col) => {
                err != null ? reject(err) : resolve(col);
              });
    ...
    }), _descriptor5 = applyDecoratedDescriptor(_class2.prototype, "dbProto", [_dec6, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor6 = applyDecoratedDescriptor(_class2.prototype, "host", [_dec7, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor7 = applyDecoratedDescriptor(_class2.prototype, "port", [_dec8, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor8 = applyDecoratedDescriptor(_class2.prototype, "dbName", [_dec9, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor9 = applyDecoratedDescriptor(_class2.prototype, "username", [_dec10, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor10 = applyDecoratedDescriptor(_class2.prototype, "password", [_dec11, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
