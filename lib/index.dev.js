...
var MongoAdapterMixin = (Module => {
  ...
  Module.defineMixin(__filename$7, BaseClass => {
    ...
    var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _init, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _class3, _temp;
    ...
    let Mixin = (_dec = globalContext$2.annotate(globalContext$2.class("Mixin", Mixin => {
      ...
      constructor(...args) {
        ...
        initializerDefineProperty(this, "_db", _descriptor2, this);

        initializerDefineProperty(this, "_host", _descriptor3, this);

        initializerDefineProperty(this, "_port", _descriptor4, this);

        initializerDefineProperty(this, "_dbName", _descriptor5, this);

        initializerDefineProperty(this, "dbProto", _descriptor6, this);

        initializerDefineProperty(this, "host", _descriptor7, this);

        initializerDefineProperty(this, "port", _descriptor8, this);

        initializerDefineProperty(this, "dbName", _descriptor9, this);

        initializerDefineProperty(this, "username", _descriptor10, this);

        initializerDefineProperty(this, "password", _descriptor11, this);

        this[_MixinTypeParametersSymbol] = _typeParameters;
        globalContext$2.ref(DriverInterface$1, this[_MixinTypeParametersSymbol].R, globalContext$2.ref("object"), this[_MixinTypeParametersSymbol].A).assert(this);
      }
      ...
      get db() {
        ...
        return this._db.then(_arg2 => _returnType10.assert(_arg2));
      }

      get collection() {
        const _returnType11 = globalContext$2.return(globalContext$2.ref("object"));
        ...
        return this._collection.then(_arg3 => _returnType11.assert(_arg3));
      }
      ...
      collectionName() {
        ...
        return _returnType12.assert(`${prefix}_${name}`);
      ...
      async push(acRecord, snapshot) {
        ...
        let _snapshotType = globalContext$2.ref("object");

        const _returnType = globalContext$2.return(globalContext$2.union(globalContext$2.ref("object"), globalContext$2.ref("Promise", globalContext$2.ref("object"))));
      ...
      async override(acRecord, id, snapshot) {
        ...
        let _snapshotType2 = globalContext$2.ref("object");

        const _returnType6 = globalContext$2.return(globalContext$2.union(globalContext$2.ref("object"), globalContext$2.ref("Promise", globalContext$2.ref("object"))));
      ...
      writable: true,
      initializer: null
    }), _descriptor2 = applyDecoratedDescriptor(_class2.prototype, "_db", [_dec3, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: null
    }), _descriptor3 = applyDecoratedDescriptor(_class2.prototype, "_host", [_dec4, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor4 = applyDecoratedDescriptor(_class2.prototype, "_port", [_dec5, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor5 = applyDecoratedDescriptor(_class2.prototype, "_dbName", [_dec6, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor6 = applyDecoratedDescriptor(_class2.prototype, "dbProto", [_dec7, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor7 = applyDecoratedDescriptor(_class2.prototype, "host", [_dec8, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor8 = applyDecoratedDescriptor(_class2.prototype, "port", [_dec9, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor9 = applyDecoratedDescriptor(_class2.prototype, "dbName", [_dec10, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor10 = applyDecoratedDescriptor(_class2.prototype, "username", [_dec11, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
    ...
    }), _descriptor11 = applyDecoratedDescriptor(_class2.prototype, "password", [_dec12, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function () {
...
var QueryableMongoAdapterMixin = (Module => {
  ...
  Module.defineMixin(__filename$9, BaseClass => {
    ...
    let Mixin = (_dec = globalContext$2.annotate(globalContext$2.class("Mixin", Mixin => {
      ...
      return [globalContext$2.extends(BaseClass), globalContext$2.staticProperty("object", globalContext$2.any()), globalContext$2.method("takeBy", globalContext$2.param("acRecord", globalContext$2.flowInto(R)), globalContext$2.param("query", globalContext$2.ref("object")), globalContext$2.param("options", globalContext$2.nullable(globalContext$2.ref("object"))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.ref(MongoNativeCursorInterface$5)))), globalContext$2.method("exists", globalContext$2.param("acRecord", globalContext$2.flowInto(R)), globalContext$2.param("query", globalContext$2.ref("object")), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.boolean()))), globalContext$2.property("operatorsMap", globalContext$2.object(globalContext$2.indexer("key", globalContext$2.string(), globalContext$2.function()))), globalContext$2.method("constructor", globalContext$2.param("args", globalContext$2.any())), globalContext$2.method("parseFilter", globalContext$2.param("acRecord", globalContext$2.Class(globalContext$2.existential())), globalContext$2.param("data", globalContext$2.object(globalContext$2.property("field", globalContext$2.nullable(globalContext$2.string()), true), globalContext$2.property("parts", globalContext$2.nullable(globalContext$2.array(globalContext$2.ref("object"))), true), globalContext$2.property("operator", globalContext$2.nullable(globalContext$2.string()), true), globalContext$2.property("operand", globalContext$2.nullable(globalContext$2.any()), true), globalContext$2.property("implicitField", globalContext$2.nullable(globalContext$2.boolean()), true))), globalContext$2.return(globalContext$2.ref("object"))), globalContext$2.method("parseQuery", globalContext$2.param("acRecord", globalContext$2.flowInto(R)), globalContext$2.param("aoQuery", globalContext$2.union(globalContext$2.ref("object"), globalContext$2.ref(QueryInterface$2))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.union(globalContext$2.ref("object"), globalContext$2.string(), globalContext$2.ref(QueryInterface$2))))), globalContext$2.method("executeQuery", globalContext$2.param("acRecord", globalContext$2.flowInto(R)), globalContext$2.param("aoQuery", globalContext$2.union(globalContext$2.ref("object"), globalContext$2.string(), globalContext$2.ref(QueryInterface$2))), globalContext$2.return(globalContext$2.ref("Promise", globalContext$2.nullable(globalContext$2.ref(MongoNativeCursorInterface$5)))))];
      ...
      async takeBy(acRecord, query, options = {}) {
        ...
        const _returnType = globalContext$2.return(globalContext$2.union(globalContext$2.ref(MongoNativeCursorInterface$5), globalContext$2.ref("Promise", globalContext$2.ref(MongoNativeCursorInterface$5))));
      ...
      parseFilter(acRecord, data) {
        let _acRecordType3 = globalContext$2.Class(globalContext$2.existential());

        let _dataType = globalContext$2.object(globalContext$2.property("field", globalContext$2.nullable(globalContext$2.string()), true), globalContext$2.property("parts", globalContext$2.nullable(globalContext$2.array(globalContext$2.ref("object"))), true), globalContext$2.property("operator", globalContext$2.nullable(globalContext$2.string()), true), globalContext$2.property("operand", globalContext$2.nullable(globalContext$2.any()), true), globalContext$2.property("implicitField", globalContext$2.nullable(globalContext$2.boolean()), true));
        ...
        if (field != null && operator !== '$elemMatch' && parts.length === 0) {
          ...
          if (field != null && operator === '$elemMatch') {
            ...
            return _returnType6.assert(this.operatorsMap[operator != null ? operator : '$and'](parts.map(this.parseFilter.bind(this, acRecord))));
          }
        }
      }
      ...
      async executeQuery(acRecord, aoQuery) {
        ...
        const _returnType4 = globalContext$2.return(globalContext$2.union(globalContext$2.nullable(globalContext$2.ref(MongoNativeCursorInterface$5)), globalContext$2.ref("Promise", globalContext$2.nullable(globalContext$2.ref(MongoNativeCursorInterface$5)))));
